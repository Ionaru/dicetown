...
ALTER TABLE "sessions" ADD CONSTRAINT "sessions_anonymous_user_id_anonymous_users_id_fk" FOREIGN KEY ("anonymous_user_id") REFERENCES "public"."anonymous_users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "sessions_anonymous_user_id_idx" ON "sessions" USING btree ("anonymous_user_id");--> statement-breakpoint
