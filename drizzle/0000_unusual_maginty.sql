...
--> statement-breakpoint
ALTER TABLE "game_state" ADD CONSTRAINT "game_state_room_id_rooms_id_fk" FOREIGN KEY ("room_id") REFERENCES "public"."rooms"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
